...
$data['lancamento'] = format_products($products_new, 'medium');
...
$data['categorias'][$categoria_esquerda] = get_is_product_category_data($categoria_esquerda);
$data['categorias'][$categoria_direita] = get_is_product_category_data($categoria_direita);
...
<li class='slide-item'><img src="<?= $product['img']  ?>" alt="<?= $product['name']  ?>">
...
<section class="container">
  ...
  <?php handel_product_list($data['lancamento']); ?>
</section>
